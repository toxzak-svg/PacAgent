...
class DecryptionError(CryptoError):
    ...
    def __init__(self, message: str = "Decryption failed", details: str = None):
        super().__init__(
            message or "Failed to decrypt data. This may be due to an incorrect password, corrupted data, or invalid format.",
            details
        )
...
class KeyDerivationError(CryptoError):
    ...
    def __init__(self, message: str = "Key derivation failed", details: str = None):
        super().__init__(
            message or "Failed to derive encryption key. This may indicate a problem with the password or salt.",
            details
        )
...
class KeychainAccessError(KeychainError):
    ...
    def __init__(self, message: str = "Failed to access keychain", details: str = None):
        super().__init__(
            message or "Unable to access the OS keychain. Please check your system's keychain permissions.",
            details
        )
...
class AgentLockReadError(AgentLockError):
    ...
    def __init__(self, file_path: str, details: str = None):
        super().__init__(
            ...
            details or "Please check file permissions and ensure the file is not locked by another process"
        )
        self.file_path = file_path
...
class InvalidKeyNameError(ValidationError):
    ...
    def __init__(self, key_name: str, reason: str = None):
        super().__init__(
            ...
            reason or "Key names must be non-empty and contain only alphanumeric characters and underscores"
        )
        self.key_name = key_name
